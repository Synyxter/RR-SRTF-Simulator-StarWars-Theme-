...
BG_IMAGE_PATH = os.path.join(ASSETS_DIR, "background_srtf_theme.jpg").replace("\\", "/") # Cambiado para tematica SRTF si se desea
ICON_VOLVER_PATH = os.path.join(ASSETS_DIR, "icon_volver_green.png").replace("\\", "/") # Icono podría ser temático
...
if __name__ == '__main__':
    ...
    try:
        ...
        BG_IMAGE_PATH = os.path.join(ASSETS_DIR_MAIN, "background_srtf_theme.jpg").replace("\\", "/")
        ...
        ICON_VOLVER_PATH = os.path.join(ASSETS_DIR_MAIN, "icon_volver_green.png").replace("\\", "/")
        ...
        BG_IMAGE_PATH = os.path.join(ASSETS_DIR, "background_srtf_theme.jpg").replace("\\", "/")
        ICON_VOLVER_PATH = os.path.join(ASSETS_DIR, "icon_volver_green.png").replace("\\", "/")


    app = ctk.CTk()
    app.title("Simulador de Planificación SRTF"); app.geometry("1280x720"); ctk.set_appearance_mode("dark")
